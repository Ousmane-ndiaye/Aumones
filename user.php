        ...
        <body>
            <?php
                ...
                echo"
                    ...
                    <h3>Menu</h3>
                    <ol>
                        <li><a style='background-color: red; color: white; font-size: 20px;' href='calcul.php'> Site du calculatrice </a></li>
                        <li><a style='background-color: red; color: white; font-size: 20px;' href='heure.php'> Site de l'heure </a></li>
                    </ol>
